...
import com.android.launcher3x.uioverrides.DisplayRotationListener;
import com.android.launcher3x.uioverrides.WallpaperColorInfo;
...
public abstract class BaseDraggingActivity extends BaseActivity
    ...
    public static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.android.launcher3x.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
        ...
        if (mThemeStyle == 1) {
            ...
            if (wallpaperColorInfo.isDark()) {
                return wallpaperColorInfo.supportsDarkText() ?
                        R.style.LauncherTheme_Dark_DarkText : R.style.LauncherTheme_Dark;
            } else {
                return wallpaperColorInfo.supportsDarkText() ?
