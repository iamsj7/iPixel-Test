...
import com.android.internal.ambient.weather.WeatherClient.WeatherInfo;
import com.android.internal.ambient.weather.WeatherClient.WeatherObserver;
...
// Event identifiers start
 ...
 // Event identifiers end
    ...
    private void deviceIntroEvent() {
        ...
        mIsQuickEvent = true;
        mEventIntro = true;
        mEventTitle = mContext.getResources().getString(R.string.quick_event_pixelhome_intro_welcome);
        mEventTitleSub = mContext.getResources().getString(R.string.quick_event_pixelhome_intro_learn);
